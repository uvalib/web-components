...
*/
const m=o`<dom-module id="vaadin-text-field-shared-styles">
  <template>
    <style>
      :host {
        display: inline-flex;
...
`}static get is(){return"vaadin-text-field"}static get version(){return"2.8.0"}static get properties(){return{list:{type:String},pattern:{type:String},title:{type:String}}}}customElements.define(b.is,b);export{b as T};
