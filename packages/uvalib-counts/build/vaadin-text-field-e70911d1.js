...
*/
const c=i`<dom-module id="vaadin-text-field-shared-styles">
  <template>
    <style>
      :host {
        display: inline-flex;
...
`}static get is(){return"vaadin-text-field"}static get version(){return"2.7.0"}static get properties(){return{list:{type:String},pattern:{type:String},title:{type:String}}}}customElements.define(g.is,g);export{g as T};
