...
*/let o,n=null,l=window.HTMLImports&&window.HTMLImports.whenReady||null;function d(e){requestAnimationFrame((function(){l?l(e):(n||(n=new Promise(e=>{o=e}),"complete"===document.readyState?o():document.addEventListener("readystatechange",()=>{"complete"===document.readyState&&o()})),n.then((function(){e&&e()})))}))}
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
...
Code distributed by Google as part of the polymer project is also
subject to an additional IP rights grant found at http://polymer.github.io/PATENTS.txt
*/const i="__shadyCSSCachedStyle";let a=null,S=null;class r{constructor(){this.customStyles=[],this.enqueued=!1,d(()=>{window.ShadyCSS.flushCustomStyles&&window.ShadyCSS.flushCustomStyles()})}enqueueDocumentValidation(){!this.enqueued&&S&&(this.enqueued=!0,d(S))}addCustomStyle(e){e.__seenByShadyCSS||(e.__seenByShadyCSS=!0,this.customStyles.push(e),this.enqueueDocumentValidation())}getStyleForCustomStyle(e){if(e[i])return e[i];let t;return t=e.getStyle?e.getStyle():e,t}processStyles(){const e=this.customStyles;for(let t=0;t<e.length;t++){const s=e[t];if(s[i])continue;const o=this.getStyleForCustomStyle(s);if(o){const e=o.__appliedElement||o;a&&a(e),s[i]=e}}return e}}r.prototype.addCustomStyle=r.prototype.addCustomStyle,r.prototype.getStyleForCustomStyle=r.prototype.getStyleForCustomStyle,r.prototype.processStyles=r.prototype.processStyles,Object.defineProperties(r.prototype,{transformCallback:{get:()=>a,set(e){a=e}},validateCallback:{get:()=>S,set(e){let t=!1;S||(t=!0),S=e,t&&this.enqueueDocumentValidation()}}});
/**
@license
Copyright (c) 2017 The Polymer Project Authors. All rights reserved.
This code may only be used under the BSD style license found at http://polymer.github.io/LICENSE.txt
